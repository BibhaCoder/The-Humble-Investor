...
3) Highly concentrated (should have ~30 to ~100 securities for any given market cap type for example micro, small, mid, large and mega market caps so a multi cap innovative growth ETF may contain ~150 to ~500 securities considering ~100 securities for each type of market cap)
