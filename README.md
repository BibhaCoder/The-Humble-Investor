...
3) Highly concentrated (should have ~30 to ~300 securities for any given market cap type for example micro, small, mid, large and mega market caps so a multi cap innovative growth ETF may contain ~150 to ~900 securities considering ~30 to ~300 securities for each type of market cap)
