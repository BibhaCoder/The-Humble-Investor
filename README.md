...
2) Activity: Stay active and do at least one hour of daily physical activity(walking, swimming, running, cycling, yoga, excercise in gym etc.)
...
I have found following ETFs which consistently meet all the above mentioned 5 principles(low cost, passively managed, highly concentrated, innovation and growth) of humble investing and following is their performance in comparison with VOO benchmark:
...
Today proshares UPRO etf(3x S&P 500) fits well for alpha strategy and as per paper(leverage for long run): https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2741701 this alpha strategy has returned an alpha of 17.8% since 1928. Using modern trading platforms stop_loss sell and buy orders and UPRO ETF this alpha strategy can be easily passively implemented.
