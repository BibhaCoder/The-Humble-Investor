...
A humble investor does not need 20 to 50 ETFs to get proper diversification. Only 4 ETFs(less than five basic human senses) focused on above 5 characteristics are good enough for a humble investor to achieve long term market beating(VOO/VTI) returns. And finally holding period for a humble investor should be forever :)
